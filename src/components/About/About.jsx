...
import { t } from "../../i18n";
import rect1 from "/src/assets/about/Rectangle_15.png";
import rect2 from "/src/assets/about/Rectangle_16.png";
import rect3 from "/src/assets/about/Rectangle_17.png";

export default function About() {
	const [activeImage, setActiveImage] = useState("/src/assets/about/Rectangle_17.png");

	const getImageClassName = imageSrc => {
		return `relative w-full h-full object-cover border-2 border-red-500 transition-all duration-300 hover:translate-x-[-5px] hover:translate-y-[-5px] hover:shadow-[4px_4px_0px_black] active:translate-x-[0px] active:translate-y-[0px] active:shadow-none ${
			activeImage === imageSrc
				? "z-10 bg-opacity-50 border-shade-3 bg-light_accent"
				: "z-0"
		}`;
	};
