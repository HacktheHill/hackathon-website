...
export default function About() {
	...
	const getImageClassName = imageSrc => {
		return `relative w-full h-full object-cover border-2 border-red-500 ${
			activeImage === imageSrc
				? "z-10 bg-opacity-50 border-shade-3 bg-light_accent transition-all duration-300 hover:translate-x-[-5px] hover:translate-y-[-5px] hover:shadow-[4px_4px_0px_black] active:translate-x-[0px] active:translate-y-[0px] active:shadow-none"
				: "z-0"
		}`;
	};
