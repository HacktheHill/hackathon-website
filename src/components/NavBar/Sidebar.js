    ...
    <Menu right width={'50%'}>
      ...
      <div className='row'>
            <a href="https://www.facebook.com/canadascapitalhackathon" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' type="logo" name="facebook-square"/>
            </a>
            <a href="https://twitter.com/hackthehiII" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' name="twitter" type="logo" />
            </a>
            <a href="https://www.instagram.com/hackthehill/" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' name="instagram" type="logo" />
            </a>
            <a href="https://www.tiktok.com/@hackthehill" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' name="tiktok" type="logo" />
            </a>
            <a href="https://www.linkedin.com/company/hackthehill/" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' name='linkedin' type='logo' ></box-icon>
            </a>
            <a href="https://www.medium.com/@hackthehill" target="_blank">
              <box-icon size='md' color='white' animation='tada-hover' name='medium' type='logo' ></box-icon>
            </a> 
      </div>   
    </Menu>
    </div>
