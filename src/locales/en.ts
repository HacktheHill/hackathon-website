export default {
	...
	hero: {
		...
		countdown: {
			...
			event_start: "Hack the Hill starts in",
			hacking_start: "Hacking starts in",
			hacking_end: "Hacking ends in",
			day: "day",
			days: "days",
			hour: "hour",
			hours: "hours",
	...
	stats: {
		title: "Hack the Hill II by the numbers",
		p1: "800+",
		p1tag: "Participants",
		p2: "1190+",
		p2tag: "Applicants",
	...
	testimonials: {
		...
		aria_label_prev: "Previous testimonial",
		aria_label_dot: "Show testimonial",
	},
	faq: {
	...
	"four-o-four": {
		...
		button: "Back to home",
		image_alt: "Bea.var, the Hack the Hill beaver mascot",
	},
} as const;
